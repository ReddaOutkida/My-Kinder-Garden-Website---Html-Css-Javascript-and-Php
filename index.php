...
<body>
    ...
    <header class="header">
        ...
        <!-- <form action="" class="login-form">
            ...
            <p><a href="signup.php" class="btn-signup">Sign up</a></p>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p>At our kindergarten, we believe in fostering a nurturing environment where children can explore new ideas, develop essential skills, and grow in confidence. 
                    Our programs are designed to encourage curiosity and creativity, allowing each child to thrive at their own pace. With dedicated teachers and a safe, supportive space, we inspire children to learn collaboratively and build friendships that last a lifetime.</p>
                <p>We focus on interactive learning through play, encouraging children to discover their interests and express themselves freely. 
                    By emphasizing teamwork, respect, and empathy, we help shape young minds into compassionate, well-rounded individuals ready to take on the world.</p>
    ...
    <section class="education" id="education">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>music lessons</h3>
                <p>Our music classes introduce children to rhythm, melody, and instruments, helping them express creativity and develop a love for music</p>
                <img src="images/education1.png" alt="">
            </div>

            <div class="box">
                <h3>sports lessons</h3>
                <p>Our sports lessons focus on teamwork, coordination, and healthy physical activity.</p>
    ...
    <section class="contact" id="contact">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>email</h3>
                <p>ReddaKinder@gmail.com</p>
                <p>KinderGarden@gmail.com</p>
            </div>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Doha Abwab Marrakech, Zone 19, Marrakech</p>
            </div>
        ...
        <div class="credit"> &copy; copyright @ 2024 by <span>ReddaOutkida</span></div>
